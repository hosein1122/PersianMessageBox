...
namespace HF
{
    partial class MessageYesNoCancel : Form
    {
        Timer timer1;

        string _Message, _Caption;
        int _Timeout;
        public MessageYesNoCancel(string message, string caption = "", int timeout = 0)
        {
            InitializeComponent();
            _Message = message;
            _Caption = caption;
        ...
        public string _YesString
        {
            set
            {
                btnYes.Text = !String.IsNullOrEmpty(value) ? value : "Exit With Save";
            }
        }
        ...
        public string _NoString
        {
            set
            {
                btnNo.Text = !String.IsNullOrEmpty(value) ? value : "Exit Without Save";
            }
        }
        ...
        public string _CancelString
        {
            set
            {
                btnCancel.Text = !String.IsNullOrEmpty(value) ? value : "Cancel";
            }
        }
